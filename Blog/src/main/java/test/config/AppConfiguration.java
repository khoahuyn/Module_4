...
//    }
    ...
    public DriverManagerDataSource getDataSource() {
        ...
        datasource.setUrl("jdbc:mysql://localhost:3306/A0102004?useSSL=false&useUnicode=true&characterEncoding=utf8");
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactory.setPackagesToScan(new String[]{"test.model"});
